                ...
                <div class="col-lg-6">
                    <div>
                        ...
                        <a href="javascript:void(0)">
                            <a href="../main/authentication-login.html" class="btn btn-primary">Log
                                In</a>
                        </a>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row justify-content-between">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    ...
                    <a href="javascript:void(0)"
                        class="fs-4 fw-bolder pb-2 border-dark border-2 border-bottom request-callback">
                        Request a Callback
                    </a>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="col-md-6 mb-7 mb-lg-5">
                            <div class="d-flex flex-column align-items-start gap-3">
                                <div class="bg-primary-subtle rounded-2 round-48 hstack justify-content-center">
                                    <iconify-icon icon="tabler:building-store"
                        ...
                        <div class="col-md-6 mb-7 mb-lg-5">
                            <div class="d-flex flex-column align-items-start gap-3">
                                <div class="bg-info-subtle rounded-2 round-48 hstack justify-content-center">
                                    <iconify-icon icon="material-symbols:category-outline"
                        ...
                        <div class="col-md-6 mb-7 mb-lg-5">
                            <div class="d-flex flex-column align-items-start gap-3 ">
                                <div class="bg-light-subtle rounded-2 round-48 hstack justify-content-center">
                                    <iconify-icon icon="material-symbols:earthquake"
        ...
        <div class="container-fluid">
            <ul class="nav nav-pills tabs-pills justify-content-between gap-3" id="pills-tab" role="tablist">
                <li class="nav-item flex-grow-1" role="presentation">
                    <button class="nav-link active fs-4 fw-semibold px-4 py-6 tabs-shadow" id="pills-home-tab"
                ...
                <li class="nav-item flex-grow-1" role="presentation">
                    <button class="nav-link fs-4 fw-semibold px-4 py-6 tabs-shadow" id="pills-profile-tab"
                ...
                <li class="nav-item flex-grow-1" role="presentation">
                    <button class="nav-link fs-4 fw-semibold px-4 py-6 tabs-shadow" id="pills-contact-tab"
                        data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab"
                        aria-controls="pills-contact" aria-selected="false">
                        <iconify-icon icon="material-symbols-light:photo-frame-outline-sharp"
                            class="fs-7"></iconify-icon>
                        Embedding
                    </button>
                </li>
                <li class="nav-item flex-grow-1" role="presentation">
                    <button class="nav-link fs-4 fw-semibold px-4 py-6 tabs-shadow" id="pills-disabled-tab"
            ...
            <div class="tab-content mt-7 mt-lg-12 pb-lg-9" id="myTabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="team-tab"
                    tabindex="0">
                ...
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="payments-tab"
                    tabindex="0">
                    <div class="row gap-lg-0 gap-7">
                        <div class="col-lg-6">
                            <div class="bg-primary-subtle rounded-24 p-13">
                ...
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="embedding-tab"
                    tabindex="0">
                    <div class="row gap-lg-0 gap-7">
                        <div class="col-lg-6">
                            <div class="bg-primary-subtle rounded-24 p-13">
                ...
                <div class="tab-pane fade" id="pills-disabled" role="tabpanel" aria-labelledby="workflows-tab"
                    tabindex="0">
                    <div class="row gap-lg-0 gap-7">
                        <div class="col-lg-6">
                            <div class="bg-primary-subtle rounded-24 p-13">
                ...
                <div class="col-lg-6 mt-md-0 mt-7">
                    <div class="owl-carousel testimonial-carousel owl-theme">
                        <div class="item">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="../assets/images/profile/user-7.jpg" alt="user" width="56px"
                                ...
                                <span class="bg-primary round-48 rounded-circle hstack justify-content-center">
                                    <img src="../assets/images/frontend-pages/icon-quotes.svg" alt="user"
                                        class="w-auto">
                                </span>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="../assets/images/profile/user-2.jpg" alt="user" width="56px"
                                        height="56px" class="rounded-circle w-auto">
                                    <div class="">
                        ...
                        <div class="item">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-3">
                                    <img src="../assets/images/profile/user-9.jpg" alt="user" width="56px"
                                        height="56px" class="rounded-circle w-auto">
                                    <div class="">
            ...
            <div class="position-relative overflow-hidden pt-5 pt-md-11">
                <div class="w-100 text-nowrap">
                    <div class="slide-animation1 d-flex gap-7 text-nowrap">
                        <!-- Feature Item 1 -->
                        <div
                            class="feature-item bg-primary-subtle rounded-3 gap-8 d-flex align-items-center justify-content-center">
                            <i class="ti ti-wand text-primary fs-7" aria-hidden="true"></i>
                            <p class="fs-3 fw-semibold mb-0 gap-3 text-primary">6 Theme Colors</p>
                        </div>
                        <!-- Feature Item 2 -->
                        <div
                            class="feature-item bg-secondary-subtle rounded-3 gap-8 d-flex align-items-center justify-content-center">
                        ...
                        <!-- Feature Item 3 -->
                        <div
                            class="feature-item bg-success-subtle rounded-3 gap-8 d-flex align-items-center justify-content-center">
                        ...
                        <!-- Feature Item 4 -->
                        <div
                            class="feature-item bg-info-subtle rounded-3 gap-8 d-flex align-items-center justify-content-center">
                            <i class="ti ti-puzzle text-info fs-7" aria-hidden="true"></i>
                            <p class="fs-3 fw-semibold mb-0 gap-3 text-info">150+ UI Components</p>
                        </div>
                        <!-- Feature Item 5 -->
                        <div
                            class="feature-item bg-warning-subtle rounded-3 gap-8 d-flex align-items-center justify-content-center">
                        ...
                        <!-- Feature Item 1 -->
                        <div
                            class="feature-item bg-danger-subtle rounded-3 gap-8 d-flex align-items-center justify-content-center">
                ...
                <div class="w-100 text-nowrap">
                    <div class="slide-animation2 d-flex gap-7 text-nowrap my-4">
                        <!-- Feature Item 6 -->
                        <div
                            class="feature-item bg-primary-subtle p-4 rounded-3 gap-8 d-flex align-items-center justify-content-center">
                            <i class="ti ti-tag text-primary fs-7" aria-hidden="true"></i>
                            <p class="fs-3 fw-semibold mb-0 gap-3 text-primary">Bootstrap 5x</p>
                        </div>
                        <!-- Feature Item 7 -->
                        <div
                            class="feature-item bg-secondary-subtle p-4 rounded-3 gap-8 d-flex align-items-center justify-content-center">
                        ...
                        <!-- Feature Item 8 -->
                        <div
                            class="feature-item bg-success-subtle p-4 rounded-3 gap-8 d-flex align-items-center justify-content-center">
                        ...
                        <!-- Feature Item 9 -->
                        <div
                            class="feature-item bg-info-subtle p-4 rounded-3 gap-8 d-flex align-items-center justify-content-center">
                            <i class="ti ti-source-code text-info fs-7" aria-hidden="true"></i>
                            <p class="fs-3 fw-semibold mb-0 gap-3 text-info">SassBase CSS</p>
                        </div>
                        <!-- Feature Item 6 -->
                        <div
                            class="feature-item bg-warning-subtle p-4 rounded-3 gap-8 d-flex align-items-center justify-content-center">
                            <i class="ti ti-tag text-warning fs-7" aria-hidden="true"></i>
                            <p class="fs-3 fw-semibold mb-0 gap-3 text-warning">Bootstrap 5x</p>
                        </div>
                        <!-- Feature Item 7 -->
                        <div
                            class="feature-item bg-danger-subtle p-4 rounded-3 gap-8 d-flex align-items-center justify-content-center">
                    ...
                    <div class="d-flex justify-content-center align-items-center mt-12">
                        <p class="text-center fs-3 fw-bold dashed-border py-1 px-2 rounded mb-0 text-muted">
                            Still have a question? <a target="_blank" href="https://discord.com/invite/XujgB8ww4n"
                                class="text-underline text-muted link-primary">Ask on
                                discord</a> or <a target="_blank" href="https://adminmart.com/support/"
                                class="text-underline text-muted link-primary">submit a
                                ticket</a>.
                        </p>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-9 text-center">
                    <a class="round-56 mx-auto rounded-2 shadow bg-white hstack justify-content-center"
