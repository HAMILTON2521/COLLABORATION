<div>
    ...
    <div class="card">
        ...
        <form class="form-horizontal" autocomplete="off" wire:submit.prevent="save">
            <div class="form-body">
                <div class="card-body">
                    <h6 class="card-title mb-0">Enter Airtel phone number and amount. PIN confirmation will be sent to
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label for="amount">Amount (minimum is Tsh 100) <x-required /></label>
