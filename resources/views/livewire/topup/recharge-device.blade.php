                            ...
                            <div class="input-group">
                                ...
                                <textarea wire:model="remarks"
                                    class="form-control @error('remarks')
                                                    is-invalid
                                                @enderror p-7 ps-2"
                                    name="remarks" id="remarks" cols="20" rows="1" placeholder="Enter remarks for this payment"></textarea>
                                @error('remarks')
                                    <x-validation-error message="{{ $message }}" />
                                @enderror
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary">Submit <span wire:loading wire:target="save"
